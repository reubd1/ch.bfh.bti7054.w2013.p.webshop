...
class OrdersTableMap extends TableMap
{
     ...
     */
    const ORDER_DATE = 'orders.ORDER_DATE';
     ...
     */
    const SHIPPING_ID = 'orders.SHIPPING_ID';

    /**
     * the column name for the BILLING_ID field
     */
    const BILLING_ID = 'orders.BILLING_ID';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(OrdersTableMap::ORDER_ID, OrdersTableMap::TOTAL, OrdersTableMap::ORDER_DATE, OrdersTableMap::USER_ID, OrdersTableMap::SHIPPING_ID, OrdersTableMap::BILLING_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(OrdersTableMap::ORDER_ID => 0, OrdersTableMap::TOTAL => 1, OrdersTableMap::ORDER_DATE => 2, OrdersTableMap::USER_ID => 3, OrdersTableMap::SHIPPING_ID => 4, OrdersTableMap::BILLING_ID => 5, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(OrdersTableMap::ORDER_ID);
            $criteria->addSelectColumn(OrdersTableMap::TOTAL);
            $criteria->addSelectColumn(OrdersTableMap::ORDER_DATE);
            $criteria->addSelectColumn(OrdersTableMap::USER_ID);
            $criteria->addSelectColumn(OrdersTableMap::SHIPPING_ID);
            $criteria->addSelectColumn(OrdersTableMap::BILLING_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(OrdersTableMap::ORDER_ID, (array) $values, Criteria::IN);
        }

        $query = OrdersQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { OrdersTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { OrdersTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(OrdersTableMap::ORDER_ID) && $criteria->keyContainsValue(OrdersTableMap::ORDER_ID) ) {
