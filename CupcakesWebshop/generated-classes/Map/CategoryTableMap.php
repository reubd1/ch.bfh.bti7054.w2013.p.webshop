...
class CategoryTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('CategoryId', 'Name', ),
        self::TYPE_STUDLYPHPNAME => array('categoryId', 'name', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::CATEGORY_ID, CategoryTableMap::NAME, ),
        self::TYPE_RAW_COLNAME   => array('CATEGORY_ID', 'NAME', ),
        self::TYPE_FIELDNAME     => array('category_id', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('CategoryId' => 0, 'Name' => 1, ),
        self::TYPE_STUDLYPHPNAME => array('categoryId' => 0, 'name' => 1, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::CATEGORY_ID => 0, CategoryTableMap::NAME => 1, ),
        self::TYPE_RAW_COLNAME   => array('CATEGORY_ID' => 0, 'NAME' => 1, ),
        self::TYPE_FIELDNAME     => array('category_id' => 0, 'name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('NAME', 'Name', 'VARCHAR', true, 48, null);
    } // initialize()
    ...
    {
        $this->addRelation('Item', '\\Item', RelationMap::ONE_TO_MANY, array('category_id' => 'category_id', ), null, null, 'Items');
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CategoryTableMap::CATEGORY_ID);
            $criteria->addSelectColumn(CategoryTableMap::NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CategoryTableMap::CATEGORY_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(CategoryTableMap::CATEGORY_ID) && $criteria->keyContainsValue(CategoryTableMap::CATEGORY_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.CategoryTableMap::CATEGORY_ID.')');
        }
