...
abstract class ShippingAddress implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ShippingAddressTableMap';
    ...
    /**
     * Compares this with another <code>ShippingAddress</code> instance.  If
     * <code>obj</code> is an instance of <code>ShippingAddress</code>, delegates to
     * <code>equals(ShippingAddress)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ShippingAddress The current object, for fluid interface
     */
    ...
    public function setShippingId($v)
    {
        ...
        if ($this->shipping_id !== $v) {
            $this->shipping_id = $v;
            $this->modifiedColumns[ShippingAddressTableMap::SHIPPING_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ShippingAddressTableMap::NAME] = true;
        }
    ...
    public function setStreet($v)
    {
        ...
        if ($this->street !== $v) {
            $this->street = $v;
            $this->modifiedColumns[ShippingAddressTableMap::STREET] = true;
        }
    ...
    public function setZip($v)
    {
        ...
        if ($this->zip !== $v) {
            $this->zip = $v;
            $this->modifiedColumns[ShippingAddressTableMap::ZIP] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[ShippingAddressTableMap::CITY] = true;
        }
    ...
    public function setCountry($v)
    {
        ...
        if ($this->country !== $v) {
            $this->country = $v;
            $this->modifiedColumns[ShippingAddressTableMap::COUNTRY] = true;
        }
    ...
    public function setAvailable($v)
    {
        ...
        if ($this->available !== $v) {
            $this->available = $v;
            $this->modifiedColumns[ShippingAddressTableMap::AVAILABLE] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[ShippingAddressTableMap::USER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ShippingAddressTableMap::translateFieldName('ShippingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipping_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ShippingAddressTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ShippingAddressTableMap::translateFieldName('Street', TableMap::TYPE_PHPNAME, $indexType)];
            $this->street = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ShippingAddressTableMap::translateFieldName('Zip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zip = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ShippingAddressTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ShippingAddressTableMap::translateFieldName('Country', TableMap::TYPE_PHPNAME, $indexType)];
            $this->country = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ShippingAddressTableMap::translateFieldName('Available', TableMap::TYPE_PHPNAME, $indexType)];
            $this->available = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ShippingAddressTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = ShippingAddressTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \ShippingAddress object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildShippingAddressQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ShippingAddress::setDeleted()
     * @see ShippingAddress::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildShippingAddressQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ShippingAddressTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ShippingAddressTableMap::SHIPPING_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SHIPPING_ID';
        }
        if ($this->isColumnModified(ShippingAddressTableMap::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(ShippingAddressTableMap::STREET)) {
            $modifiedColumns[':p' . $index++]  = 'STREET';
        }
        if ($this->isColumnModified(ShippingAddressTableMap::ZIP)) {
            $modifiedColumns[':p' . $index++]  = 'ZIP';
        }
        if ($this->isColumnModified(ShippingAddressTableMap::CITY)) {
            $modifiedColumns[':p' . $index++]  = 'CITY';
        }
        if ($this->isColumnModified(ShippingAddressTableMap::COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'COUNTRY';
        }
        if ($this->isColumnModified(ShippingAddressTableMap::AVAILABLE)) {
            $modifiedColumns[':p' . $index++]  = 'AVAILABLE';
        }
        if ($this->isColumnModified(ShippingAddressTableMap::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }

        $sql = sprintf(
            'INSERT INTO shipping_address (%s) VALUES (%s)',
    ...
    {
        $pos = ShippingAddressTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ShippingAddress'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ShippingAddress'][$this->getPrimaryKey()] = true;
        $keys = ShippingAddressTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getShippingId(),
            $keys[1] => $this->getName(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setShippingId($arr[$keys[0]]);
        ...
        if (array_key_exists($keys[6], $arr)) $this->setAvailable($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ShippingAddressTableMap::SHIPPING_ID)) $criteria->add(ShippingAddressTableMap::SHIPPING_ID, $this->shipping_id);
        if ($this->isColumnModified(ShippingAddressTableMap::NAME)) $criteria->add(ShippingAddressTableMap::NAME, $this->name);
        if ($this->isColumnModified(ShippingAddressTableMap::STREET)) $criteria->add(ShippingAddressTableMap::STREET, $this->street);
        if ($this->isColumnModified(ShippingAddressTableMap::ZIP)) $criteria->add(ShippingAddressTableMap::ZIP, $this->zip);
        if ($this->isColumnModified(ShippingAddressTableMap::CITY)) $criteria->add(ShippingAddressTableMap::CITY, $this->city);
        if ($this->isColumnModified(ShippingAddressTableMap::COUNTRY)) $criteria->add(ShippingAddressTableMap::COUNTRY, $this->country);
        if ($this->isColumnModified(ShippingAddressTableMap::AVAILABLE)) $criteria->add(ShippingAddressTableMap::AVAILABLE, $this->available);
        if ($this->isColumnModified(ShippingAddressTableMap::USER_ID)) $criteria->add(ShippingAddressTableMap::USER_ID, $this->user_id);
    ...
    {
        $criteria = new Criteria(ShippingAddressTableMap::DATABASE_NAME);
        $criteria->add(ShippingAddressTableMap::SHIPPING_ID, $this->shipping_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getShippingId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ShippingAddress (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setShippingId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \ShippingAddress Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addShippingAddresses($this);
             */
        }
     ...
     * If this ChildShippingAddress is new, it will return
     ...
     * actually need in ShippingAddress.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ShippingAddressTableMap::DEFAULT_STRING_FORMAT);
    }
