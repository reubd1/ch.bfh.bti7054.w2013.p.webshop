 ...
 *
 * @method     ChildCustomItemQuery leftJoinOrders($relationAlias = null) Adds a LEFT JOIN clause to the query using the Orders relation
 * @method     ChildCustomItemQuery rightJoinOrders($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Orders relation
 * @method     ChildCustomItemQuery innerJoinOrders($relationAlias = null) Adds a INNER JOIN clause to the query using the Orders relation
 *
...
abstract class CustomItemQuery extends ModelCriteria
{
    ...
    public function filterByOrders($orders, $comparison = null)
    {
        if ($orders instanceof \Orders) {
            return $this
                ->addUsingAlias(CustomItemTableMap::ORDER_ID, $orders->getOrderId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CustomItemTableMap::ORDER_ID, $orders->toKeyValue('PrimaryKey', 'OrderId'), $comparison);
        } else {
