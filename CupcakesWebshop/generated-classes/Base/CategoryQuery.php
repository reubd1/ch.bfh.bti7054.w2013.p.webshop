 ...
 * @method     array findByName(string $name) Return ChildCategory objects filtered by the name column
 *
 */
abstract class CategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bti7054', $modelName = '\\Category', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT CATEGORY_ID, NAME FROM category WHERE CATEGORY_ID = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::CATEGORY_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::CATEGORY_ID, $keys, Criteria::IN);
    }
    ...
    public function filterByCategoryId($categoryId = null, $comparison = null)
    {
        if (is_array($categoryId)) {
            ...
            if (isset($categoryId['min'])) {
                $this->addUsingAlias(CategoryTableMap::CATEGORY_ID, $categoryId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($categoryId['max'])) {
                $this->addUsingAlias(CategoryTableMap::CATEGORY_ID, $categoryId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::CATEGORY_ID, $categoryId, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::NAME, $name, $comparison);
    }
    ...
    public function filterByItem($item, $comparison = null)
    {
        if ($item instanceof \Item) {
            return $this
                ->addUsingAlias(CategoryTableMap::CATEGORY_ID, $item->getCategoryId(), $comparison);
    ...
    {
        if ($category) {
            $this->addUsingAlias(CategoryTableMap::CATEGORY_ID, $category->getCategoryId(), Criteria::NOT_EQUAL);
        }
