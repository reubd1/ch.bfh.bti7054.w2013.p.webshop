...
abstract class Decoration implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DecorationTableMap';
    ...
    /**
     * Initializes internal state of Base\Decoration object.
     */
    ...
    /**
     * Compares this with another <code>Decoration</code> instance.  If
     * <code>obj</code> is an instance of <code>Decoration</code>, delegates to
     * <code>equals(Decoration)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return Decoration The current object, for fluid interface
     */
     ...
     * @return   \Decoration The current object (for fluent API support)
     */
    public function setDecoId($v)
    {
        ...
        if ($this->deco_id !== $v) {
            $this->deco_id = $v;
            $this->modifiedColumns[DecorationTableMap::DECO_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[DecorationTableMap::NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[DecorationTableMap::DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DecorationTableMap::translateFieldName('DecoId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->deco_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DecorationTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DecorationTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = DecorationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Decoration object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDecorationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Decoration::setDeleted()
     * @see Decoration::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildDecorationQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DecorationTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[DecorationTableMap::DECO_ID] = true;
        if (null !== $this->deco_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . DecorationTableMap::DECO_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(DecorationTableMap::DECO_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DECO_ID';
        }
        if ($this->isColumnModified(DecorationTableMap::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(DecorationTableMap::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'DESCRIPTION';
        }

        $sql = sprintf(
            'INSERT INTO decoration (%s) VALUES (%s)',
    ...
    {
        $pos = DecorationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Decoration'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Decoration'][$this->getPrimaryKey()] = true;
        $keys = DecorationTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getDecoId(),
            $keys[1] => $this->getName(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setDecoId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DecorationTableMap::DECO_ID)) $criteria->add(DecorationTableMap::DECO_ID, $this->deco_id);
        if ($this->isColumnModified(DecorationTableMap::NAME)) $criteria->add(DecorationTableMap::NAME, $this->name);
        if ($this->isColumnModified(DecorationTableMap::DESCRIPTION)) $criteria->add(DecorationTableMap::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(DecorationTableMap::DATABASE_NAME);
        $criteria->add(DecorationTableMap::DECO_ID, $this->deco_id);
    ...
    /**
     * Generic method to set the primary key (deco_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Decoration (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setDecoId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Decoration Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildDecoration is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildDecoration The current object (for fluent API support)
     */
    public function setCustomItems(Collection $customItems, ConnectionInterface $con = null)
    {
        ...
        foreach ($customItemsToDelete as $customItemRemoved) {
            $customItemRemoved->setDecoration(null);
        }
     ...
     * Otherwise if this Decoration is new, it will return
     * an empty collection; or if this Decoration has previously
     * been saved, it will retrieve related CustomItems from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Decoration.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(DecorationTableMap::DEFAULT_STRING_FORMAT);
    }
