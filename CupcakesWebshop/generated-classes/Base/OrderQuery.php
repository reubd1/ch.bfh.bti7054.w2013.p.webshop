 ...
 * @method     ChildOrderQuery orderByTotal($order = Criteria::ASC) Order by the total column
 ...
 * @method     ChildOrderQuery orderByBillingId($order = Criteria::ASC) Order by the billing_id column
 *
 * @method     ChildOrderQuery groupByOrderId() Group by the order_id column
 * @method     ChildOrderQuery groupByTotal() Group by the total column
 ...
 * @method     ChildOrderQuery groupByBillingId() Group by the billing_id column
 *
 ...
 *
 * @method     ChildOrderQuery leftJoinBilling($relationAlias = null) Adds a LEFT JOIN clause to the query using the Billing relation
 * @method     ChildOrderQuery rightJoinBilling($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Billing relation
 * @method     ChildOrderQuery innerJoinBilling($relationAlias = null) Adds a INNER JOIN clause to the query using the Billing relation
 *
 * @method     ChildOrderQuery leftJoinShippingAddress($relationAlias = null) Adds a LEFT JOIN clause to the query using the ShippingAddress relation
 * @method     ChildOrderQuery rightJoinShippingAddress($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ShippingAddress relation
 * @method     ChildOrderQuery innerJoinShippingAddress($relationAlias = null) Adds a INNER JOIN clause to the query using the ShippingAddress relation
 *
 * @method     ChildOrderQuery leftJoinOrderItems($relationAlias = null) Adds a LEFT JOIN clause to the query using the OrderItems relation
 * @method     ChildOrderQuery rightJoinOrderItems($relationAlias = null) Adds a RIGHT JOIN clause to the query using the OrderItems relation
 * @method     ChildOrderQuery innerJoinOrderItems($relationAlias = null) Adds a INNER JOIN clause to the query using the OrderItems relation
 *
 * @method     ChildOrderQuery leftJoinCustomItem($relationAlias = null) Adds a LEFT JOIN clause to the query using the CustomItem relation
 * @method     ChildOrderQuery rightJoinCustomItem($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CustomItem relation
 * @method     ChildOrderQuery innerJoinCustomItem($relationAlias = null) Adds a INNER JOIN clause to the query using the CustomItem relation
 *
 ...
 * @method     ChildOrder findOneByTotal(double $total) Return the first ChildOrder filtered by the total column
 * @method     ChildOrder findOneByOrderDate(string $order_date) Return the first ChildOrder filtered by the order_date column
 * @method     ChildOrder findOneByUserId(int $user_id) Return the first ChildOrder filtered by the user_id column
 * @method     ChildOrder findOneByShippingId(int $shipping_id) Return the first ChildOrder filtered by the shipping_id column
 * @method     ChildOrder findOneByBillingId(int $billing_id) Return the first ChildOrder filtered by the billing_id column
 *
 * @method     array findByOrderId(int $order_id) Return ChildOrder objects filtered by the order_id column
 * @method     array findByTotal(double $total) Return ChildOrder objects filtered by the total column
 * @method     array findByOrderDate(string $order_date) Return ChildOrder objects filtered by the order_date column
 * @method     array findByUserId(int $user_id) Return ChildOrder objects filtered by the user_id column
 * @method     array findByShippingId(int $shipping_id) Return ChildOrder objects filtered by the shipping_id column
 * @method     array findByBillingId(int $billing_id) Return ChildOrder objects filtered by the billing_id column
 *
 */
abstract class OrderQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bti7054', $modelName = '\\Order', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT ORDER_ID, TOTAL, ORDER_DATE, USER_ID, SHIPPING_ID, BILLING_ID FROM order WHERE ORDER_ID = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(OrderTableMap::ORDER_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(OrderTableMap::ORDER_ID, $keys, Criteria::IN);
    }
    ...
    public function filterByOrderId($orderId = null, $comparison = null)
    {
        if (is_array($orderId)) {
            ...
            if (isset($orderId['min'])) {
                $this->addUsingAlias(OrderTableMap::ORDER_ID, $orderId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($orderId['max'])) {
                $this->addUsingAlias(OrderTableMap::ORDER_ID, $orderId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderTableMap::ORDER_ID, $orderId, $comparison);
    }
    ...
    public function filterByTotal($total = null, $comparison = null)
    {
        if (is_array($total)) {
            $useMinMax = false;
            if (isset($total['min'])) {
                $this->addUsingAlias(OrderTableMap::TOTAL, $total['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($total['max'])) {
                $this->addUsingAlias(OrderTableMap::TOTAL, $total['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderTableMap::TOTAL, $total, $comparison);
    }
    ...
    public function filterByOrderDate($orderDate = null, $comparison = null)
    {
        if (is_array($orderDate)) {
            ...
            if (isset($orderDate['min'])) {
                $this->addUsingAlias(OrderTableMap::ORDER_DATE, $orderDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($orderDate['max'])) {
                $this->addUsingAlias(OrderTableMap::ORDER_DATE, $orderDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderTableMap::ORDER_DATE, $orderDate, $comparison);
    }
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(OrderTableMap::USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(OrderTableMap::USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderTableMap::USER_ID, $userId, $comparison);
    }
    ...
    public function filterByShippingId($shippingId = null, $comparison = null)
    {
        if (is_array($shippingId)) {
            ...
            if (isset($shippingId['min'])) {
                $this->addUsingAlias(OrderTableMap::SHIPPING_ID, $shippingId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($shippingId['max'])) {
                $this->addUsingAlias(OrderTableMap::SHIPPING_ID, $shippingId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderTableMap::SHIPPING_ID, $shippingId, $comparison);
    }
    ...
    public function filterByBillingId($billingId = null, $comparison = null)
    {
        if (is_array($billingId)) {
            ...
            if (isset($billingId['min'])) {
                $this->addUsingAlias(OrderTableMap::BILLING_ID, $billingId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($billingId['max'])) {
                $this->addUsingAlias(OrderTableMap::BILLING_ID, $billingId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderTableMap::BILLING_ID, $billingId, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \User) {
            return $this
                ->addUsingAlias(OrderTableMap::USER_ID, $user->getUserId(), $comparison);
            ...
            return $this
                ->addUsingAlias(OrderTableMap::USER_ID, $user->toKeyValue('PrimaryKey', 'UserId'), $comparison);
        } else {
    ...
    public function filterByBilling($billing, $comparison = null)
    {
        if ($billing instanceof \Billing) {
            return $this
                ->addUsingAlias(OrderTableMap::BILLING_ID, $billing->getBillingId(), $comparison);
            ...
            return $this
                ->addUsingAlias(OrderTableMap::BILLING_ID, $billing->toKeyValue('PrimaryKey', 'BillingId'), $comparison);
        } else {
    ...
    public function filterByShippingAddress($shippingAddress, $comparison = null)
    {
        if ($shippingAddress instanceof \ShippingAddress) {
            return $this
                ->addUsingAlias(OrderTableMap::SHIPPING_ID, $shippingAddress->getShippingId(), $comparison);
            ...
            return $this
                ->addUsingAlias(OrderTableMap::SHIPPING_ID, $shippingAddress->toKeyValue('PrimaryKey', 'ShippingId'), $comparison);
        } else {
    ...
    public function filterByOrderItems($orderItems, $comparison = null)
    {
        if ($orderItems instanceof \OrderItems) {
            return $this
                ->addUsingAlias(OrderTableMap::ORDER_ID, $orderItems->getOrderId(), $comparison);
    ...
    public function filterByCustomItem($customItem, $comparison = null)
    {
        if ($customItem instanceof \CustomItem) {
            return $this
                ->addUsingAlias(OrderTableMap::ORDER_ID, $customItem->getOrderId(), $comparison);
    ...
    {
        if ($order) {
            $this->addUsingAlias(OrderTableMap::ORDER_ID, $order->getOrderId(), Criteria::NOT_EQUAL);
        }
