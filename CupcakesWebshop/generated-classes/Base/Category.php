...
abstract class Category implements ActiveRecordInterface
{
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[CategoryTableMap::CATEGORY_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CategoryTableMap::NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Category object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::CATEGORY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CATEGORY_ID';
        }
        if ($this->isColumnModified(CategoryTableMap::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::CATEGORY_ID)) $criteria->add(CategoryTableMap::CATEGORY_ID, $this->category_id);
        if ($this->isColumnModified(CategoryTableMap::NAME)) $criteria->add(CategoryTableMap::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(CategoryTableMap::DATABASE_NAME);
        $criteria->add(CategoryTableMap::CATEGORY_ID, $this->category_id);
     ...
     * @return Collection|ChildItem[] List of ChildItem objects
     * @throws PropelException
     */
    public function getItems($criteria = null, ConnectionInterface $con = null)
    {
