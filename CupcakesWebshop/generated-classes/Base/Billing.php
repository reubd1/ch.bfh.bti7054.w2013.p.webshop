...
abstract class Billing implements ActiveRecordInterface
{
     ...
     * @return Collection|ChildOrders[] List of ChildOrders objects
     */
    public function getOrderssJoinShippingAddress($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrdersQuery::create(null, $criteria);
