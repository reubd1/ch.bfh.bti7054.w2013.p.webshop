...
abstract class Topping implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ToppingTableMap';
    ...
    /**
     * Initializes internal state of Base\Topping object.
     */
    ...
    /**
     * Compares this with another <code>Topping</code> instance.  If
     * <code>obj</code> is an instance of <code>Topping</code>, delegates to
     * <code>equals(Topping)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return Topping The current object, for fluid interface
     */
     ...
     * @return   \Topping The current object (for fluent API support)
     */
    public function setToppingId($v)
    {
        ...
        if ($this->topping_id !== $v) {
            $this->topping_id = $v;
            $this->modifiedColumns[ToppingTableMap::TOPPING_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ToppingTableMap::NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[ToppingTableMap::DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ToppingTableMap::translateFieldName('ToppingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->topping_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ToppingTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ToppingTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ToppingTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Topping object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildToppingQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Topping::setDeleted()
     * @see Topping::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildToppingQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ToppingTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ToppingTableMap::TOPPING_ID] = true;
        if (null !== $this->topping_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ToppingTableMap::TOPPING_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ToppingTableMap::TOPPING_ID)) {
            $modifiedColumns[':p' . $index++]  = 'TOPPING_ID';
        }
        if ($this->isColumnModified(ToppingTableMap::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(ToppingTableMap::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'DESCRIPTION';
        }

        $sql = sprintf(
            'INSERT INTO topping (%s) VALUES (%s)',
    ...
    {
        $pos = ToppingTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Topping'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Topping'][$this->getPrimaryKey()] = true;
        $keys = ToppingTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getToppingId(),
            $keys[1] => $this->getName(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setToppingId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ToppingTableMap::TOPPING_ID)) $criteria->add(ToppingTableMap::TOPPING_ID, $this->topping_id);
        if ($this->isColumnModified(ToppingTableMap::NAME)) $criteria->add(ToppingTableMap::NAME, $this->name);
        if ($this->isColumnModified(ToppingTableMap::DESCRIPTION)) $criteria->add(ToppingTableMap::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(ToppingTableMap::DATABASE_NAME);
        $criteria->add(ToppingTableMap::TOPPING_ID, $this->topping_id);
    ...
    /**
     * Generic method to set the primary key (topping_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Topping (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setToppingId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Topping Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTopping is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildTopping The current object (for fluent API support)
     */
    public function setCustomItems(Collection $customItems, ConnectionInterface $con = null)
    {
        ...
        foreach ($customItemsToDelete as $customItemRemoved) {
            $customItemRemoved->setTopping(null);
        }
     ...
     * Otherwise if this Topping is new, it will return
     * an empty collection; or if this Topping has previously
     * been saved, it will retrieve related CustomItems from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Topping.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ToppingTableMap::DEFAULT_STRING_FORMAT);
    }
