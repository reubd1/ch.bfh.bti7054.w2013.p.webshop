...
abstract class Cake implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CakeTableMap';
    ...
    /**
     * Initializes internal state of Base\Cake object.
     */
    ...
    /**
     * Compares this with another <code>Cake</code> instance.  If
     * <code>obj</code> is an instance of <code>Cake</code>, delegates to
     * <code>equals(Cake)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return Cake The current object, for fluid interface
     */
     ...
     * @return   \Cake The current object (for fluent API support)
     */
    public function setCakeId($v)
    {
        ...
        if ($this->cake_id !== $v) {
            $this->cake_id = $v;
            $this->modifiedColumns[CakeTableMap::CAKE_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CakeTableMap::NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CakeTableMap::DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CakeTableMap::translateFieldName('CakeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cake_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CakeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CakeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CakeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Cake object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCakeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCakeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CakeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[CakeTableMap::CAKE_ID] = true;
        if (null !== $this->cake_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CakeTableMap::CAKE_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CakeTableMap::CAKE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CAKE_ID';
        }
        if ($this->isColumnModified(CakeTableMap::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'NAME';
        }
        if ($this->isColumnModified(CakeTableMap::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'DESCRIPTION';
        }

        $sql = sprintf(
            'INSERT INTO cake (%s) VALUES (%s)',
    ...
    {
        $pos = CakeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Cake'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Cake'][$this->getPrimaryKey()] = true;
        $keys = CakeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCakeId(),
            $keys[1] => $this->getName(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setCakeId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CakeTableMap::CAKE_ID)) $criteria->add(CakeTableMap::CAKE_ID, $this->cake_id);
        if ($this->isColumnModified(CakeTableMap::NAME)) $criteria->add(CakeTableMap::NAME, $this->name);
        if ($this->isColumnModified(CakeTableMap::DESCRIPTION)) $criteria->add(CakeTableMap::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(CakeTableMap::DATABASE_NAME);
        $criteria->add(CakeTableMap::CAKE_ID, $this->cake_id);
    ...
    /**
     * Generic method to set the primary key (cake_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Cake (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCakeId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Cake Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCake is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildCake The current object (for fluent API support)
     */
    public function setCustomItems(Collection $customItems, ConnectionInterface $con = null)
    {
        ...
        foreach ($customItemsToDelete as $customItemRemoved) {
            $customItemRemoved->setCake(null);
        }
     ...
     * Otherwise if this Cake is new, it will return
     * an empty collection; or if this Cake has previously
     * been saved, it will retrieve related CustomItems from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Cake.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(CakeTableMap::DEFAULT_STRING_FORMAT);
    }
